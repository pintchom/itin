-- CreateEnum
CREATE TYPE "PartyRole" AS ENUM ('HOST', 'MEMBER');
...
-- CreateIndex
CREATE INDEX "Party_createdById_idx" ON "Party"("createdById");
...
-- CreateIndex
CREATE INDEX "Invite_partyId_idx" ON "Invite"("partyId");
...
-- AddForeignKey
ALTER TABLE "Invite" ADD CONSTRAINT "Invite_partyId_fkey" FOREIGN KEY ("partyId") REFERENCES "Party"("id") ON DELETE CASCADE ON UPDATE CASCADE;
